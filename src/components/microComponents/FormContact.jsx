...
const FormContact = () => {
	...
	return (
		<div className="">
			<Tilt
				className="w-full mb-4 md:mb-16"
				options={{
					max: 4,
					scale: 1,
					speed: 200,
			...
			>
				...
				>
					<div>
						{/* form */}
						<div className="min-w-screen flex items-center justify-center relative">
							<div className="bg-gray-100 text-gray-500 rounded-xl border-main-green hover:border-main-pink hover:opacity-[99] duration-400 border-[2px] shadow-xl w-full overflow-hidden">
								<div className="md:flex w-full">
									<div className="hidden md:block w-1/2 bg-contact py-10 px-10 relative">
										{/* person and phone */}
										<svg
