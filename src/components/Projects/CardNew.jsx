						...
						<div  className="w-full flex flex-wrap justify-between pt-4">
							...
							<div className="flex gap-x-1 flex-wrap">
								{project?.tags?.map((tag, index) => {
									return (
										<img
											className={`w-[35px] ${tag?.name==="typescript" && "!w-[30px] h-[32px]"}
										 	`}
											key={index}
											src={tag?.image}
											alt={tag?.name}
